...
export class News extends Component {
  ...
  constructor(props) {
    super(props);
    // console.log("hello i am from newsitem");
    this.state = {
      articles: [],
      loading: false,
      page: 1,
  ...
  render() {
    return (
      <>
        <h2 className="text-center" style={{margin:'35px 0px',marginTop:'90px'}}>NewsWave - Top {this.capitalizeFirstLetter(this.props.category)} Headlines</h2>
